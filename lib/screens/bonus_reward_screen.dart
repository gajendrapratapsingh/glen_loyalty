...
class BonusRewardScreen extends StatefulWidget {
  const BonusRewardScreen({Key key}) : super(key: key);

  @override
  _BonusRewardScreenState createState() => _BonusRewardScreenState();
}

class _BonusRewardScreenState extends State<BonusRewardScreen> {
